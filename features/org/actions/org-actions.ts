...
import { createOrganizationSchema, inviteMemberSchema, removeMemberSchema, updateMemberRoleSchema } from '../schemas';
...
export async function inviteMember(prevState: ActionState, formData: FormData): Promise<ActionState> {
...
export async function removeMember(orgId: string, memberId: string): Promise<ActionState> {
...
export async function updateMemberRole(orgId: string, memberId: string, newRole: 'OWNER' | 'MEMBER'): Promise<ActionState> {
