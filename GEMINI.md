...
- TypeScript v5 (Strict Mode) + Next.js v16.1.4 (App Router), Supabase Auth, next-intl (004-fix-auth-redirects)
- Supabase (PostgreSQL) - User sessions managed by Supabase Auth (004-fix-auth-redirects)
